export const Package2 = () => {
  return (
    <section className='self-end text-right mt-10 border-4 border-packageDarkGreen bg-packageBg hover:border-hostingButton w-[80%] transition duration-500 hover:-translate-y-2'>
